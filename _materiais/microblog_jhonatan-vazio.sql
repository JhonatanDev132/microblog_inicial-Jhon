...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06/10/2023 às 16:49
...
--
-- Banco de dados: `microblog_jhonatan`
--
CREATE DATABASE IF NOT EXISTS `microblog_jhonatan` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `microblog_jhonatan`;
